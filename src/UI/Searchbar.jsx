...
const Searchbar = () => {
  const [searchColor, SetSearchColor] = useState('#ccc3c3');
 function changeToDark(){
  SetSearchColor('#202124')
 }
 function changeToWhite(){
  SetSearchColor('#ccc3c3');
 }
  return (
    <div className={classes.input}>
      <input
        style={{backgroundColor:searchColor=="#202124"?'white':'#4B4C4E'}}
        onClick={changeToDark}
        onBlur={changeToWhite}
